 ...
 * @version $Id: FastScrollDelegate, v 0.1 2018/11/23 18:58 shouh Exp$
 */
public class FastScrollDelegate {
    ...
    private FastScrollDelegate(final FastScrollable fastScrollable, int width, int height, Drawable thumbDrawable, boolean isDynamicHeight) {
        ...
        this.mThumbMinHeight = Utils.dp2px(context, FASTSCROLLER_MIN_HEIGHT_DP);
    ...
    public void setThumbSize(int widthDp, int heightDp) {
        mThumbRect.left = mThumbRect.right - Utils.dp2px(context, widthDp);
        mThumbMinHeight = Utils.dp2px(context, heightDp);
        updateThumbRect(0);
    }
    ...
    public static class IndicatorPopup {
        ...
        public static class Builder {
            ...
            public Builder(FastScrollDelegate delegate) {
                ...
                indicatorPopupSize = Utils.dp2px(context, FASTSCROLLER_INDICATOR_SIZE_DP);
                indicatorTextSize = Utils.dp2px(context, FASTSCROLLER_INDICATOR_TEXTSIZE_DP);
                indicatorMarginRight = Utils.dp2px(context, FASTSCROLLER_INDICATOR_MARINRIGHT_DP);
            }
            ...
            public Builder indicatorPopupSize(int popupSizeDp) {
                indicatorPopupSize = Utils.dp2px(context, popupSizeDp);
                return this;
            }

            public Builder indicatorTextSize(int textSizeDp) {
                indicatorTextSize = Utils.dp2px(context, textSizeDp);
                return this;
            }

            public Builder indicatorMarginRight(int marginRightDp) {
                indicatorMarginRight = Utils.dp2px(context, marginRightDp);
                return this;
            }
    ...
    public static class Builder {
        ...
        public Builder(FastScrollable fastScrollable) {
            super();
            this.context = fastScrollable.getFastScrollableView().getContext();
            this.fastScrollable = fastScrollable;
            width = Utils.dp2px(context, FASTSCROLLER_WIDTH_DP);
            height = Utils.dp2px(context, FASTSCROLLER_MIN_HEIGHT_DP);
        }

        public Builder width(float widthDp) {
            width = Utils.dp2px(context, widthDp);
            return this;
        }

        public Builder height(float heightDp) {
            height = Utils.dp2px(context, heightDp);
            return this;
        }
        ...
        private Drawable makeDefaultThumbDrawable() {
            ...
            final int inset = Utils.dp2px(context, FASTSCROLLER_THUMB_INSET_TOP_BOTTOM_RIGHT);// inset
            final int insetLeft = width - inset - Utils.dp2px(context, FASTSCROLLER_THUMB_WIDTH);
            pressedDrawable.setCornerRadius(radius);
            stateListDrawable.addState(DRAWABLE_STATE_PRESSED,
                    new InsetDrawable(pressedDrawable, insetLeft, inset, inset, inset));
            ...
            stateListDrawable.addState(DRAWABLE_STATE_DEFAULT,
                    new InsetDrawable(normalDrawable, insetLeft, inset, inset, inset));

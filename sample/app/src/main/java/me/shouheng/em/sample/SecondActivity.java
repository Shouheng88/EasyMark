...
import me.shouheng.em.sample.widget.MDEditorLayout;
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.item_view:
                ...
                intent.putExtra(me.shouheng.em.sample.ViewerActivity.EXTRA_KEY_NOTE_CONTENT, mel.getEditText().getText().toString());

...
import me.shouheng.em.sample.R;
...
public class ViewerActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_KEY_NOTE_CONTENT = "__extra_key_note_content";

    private static final boolean isDarkTheme = true;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        /* Set the css content */
        emv.setCustomCss(Utils.readAssetsContent(this, "dark_style.css"));
